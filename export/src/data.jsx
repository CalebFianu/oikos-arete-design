...
const VENDORS = [
  ...
  // HMUA
  { id: 'v08', name: 'House of Lumière', cat: 'hmua', city: 'Lagos', tier: 3, rating: 4.95, tags: ['bridal','editorial','runway'], blurb: 'Editorial-grade hair and makeup for the day you intend to remember.', phone: '+233 56 004 8680', email: 'studio@houseoflumiere.co', web: 'houseoflumiere.co', ig: '@house.of.lumiere', tile: ['#2a2018','#d4b66c'] },
  { id: 'v09', name: 'Atelier Noir', cat: 'hmua', city: 'London', tier: 3, rating: 4.85, tags: ['bridal','soft glam','natural'], blurb: 'Quiet luxury, applied. Skin first. Always.', phone: '+233 56 004 8680', email: 'bookings@ateliernoir.uk', web: 'ateliernoir.uk', ig: '@ateliernoir.uk', tile: ['#0e0e0c','#a88a4a'] },
  { id: 'v10', name: 'Studio Ọ̀là', cat: 'hmua', city: 'Abuja', tier: 2, rating: 4.7, tags: ['bridal','traditional','party'], blurb: 'Modern face, traditional language. We speak both.', phone: '+233 56 004 8680', email: 'team@studio-ola.com', web: 'studio-ola.com', ig: '@studio.ola', tile: ['#3a1a22','#c89544'] },
  ...
  // DJs
  { id: 'v17', name: 'DJ Kola', cat: 'djs', city: 'Lagos', tier: 3, rating: 4.92, tags: ['afrobeats','house','wedding'], blurb: 'Reads a room before walking into it. Twelve-hour sets without fatigue.', phone: '+233 56 004 8680', email: 'bookings@kola.fm', web: 'kola.fm', ig: '@dj.kola', tile: ['#0e0e0c','#a88a4a'] },
  { id: 'v18', name: 'Selectah Ré', cat: 'djs', city: 'Abuja', tier: 2, rating: 4.7, tags: ['soul','classics','intimate'], blurb: 'Vinyl-first. Soul, jazz, lover\u2019s rock. Dinner-to-dancefloor specialist.', phone: '+233 56 004 8680', email: 'mgmt@selectah-re.com', web: 'selectah-re.com', ig: '@selectah.re', tile: ['#3a1a22','#c89544'] },

  // MCs
  { id: 'v19', name: 'Olu Adesanya', cat: 'mcs', city: 'Lagos', tier: 3, rating: 4.9, tags: ['bilingual','formal','warm'], blurb: 'Hosts in three languages, never overstays the moment.', phone: '+233 56 004 8680', email: 'mgmt@oluadesanya.co', web: 'oluadesanya.co', ig: '@olu.adesanya', tile: ['#1a1612','#9a7838'] },
  { id: 'v20', name: 'Ms. Adwoa Mensah', cat: 'mcs', city: 'Accra', tier: 2, rating: 4.75, tags: ['corporate','english','french'], blurb: 'Corporate hosting with a vanishingly light touch.', phone: '+233 56 004 8680', email: 'hello@adwoa.co', web: 'adwoa.co', ig: '@adwoa.host', tile: ['#2a1810','#b4894a'] },

  // Mixology
  { id: 'v21', name: 'The Velvet Bar', cat: 'mixology', city: 'Lagos', tier: 3, rating: 4.88, tags: ['bespoke menu','tableside','rare spirits'], blurb: 'Cocktails as portraits — built for your guests, not your party.', phone: '+233 56 004 8680', email: 'salon@velvetbar.co', web: 'velvetbar.co', ig: '@thevelvetbar', tile: ['#0e0e0c','#5C1A2B'] },
  { id: 'v22', name: 'Highball & Co.', cat: 'mixology', city: 'Cape Town', tier: 2, rating: 4.65, tags: ['classics','low-abv','fast'], blurb: 'A fast, accurate bar program for events of 200+.', phone: '+233 56 004 8680', email: 'hello@highball.za', web: 'highball.za', ig: '@highball.co', tile: ['#1a1410','#a88a4a'] },
];
